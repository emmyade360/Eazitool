...
export const CV_BUILDER_COPY: Record<LanguageCode, {
  ...
  en: {
    ...
    generating: "Generating 3 CV variants with AI...",
    generateButton: "Generate my 3 CVs",
  ...
  fr: {
    ...
    generating: "Generation de 3 variantes de CV avec l'IA...",
    generateButton: "Generer mes 3 CV",
  ...
  es: {
    ...
    generating: "Generando 3 variantes de CV con IA...",
    generateButton: "Generar mis 3 CVs",
  ...
  pt: {
    ...
    generating: "A gerar 3 variantes de CV com IA...",
    generateButton: "Gerar os meus 3 CVs",
  ...
  sw: {
    ...
    generating: "Inazalisha aina 3 za CV kwa AI...",
    generateButton: "Nizalie CV 3",
